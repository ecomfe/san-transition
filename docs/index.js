...
if (__san_script__ &&
  ...
  console.warn("[san-loader] docs/src/components/App.san: named exports in *.san files are ignored.")}
      ...
      parent.updateView = function (changes) {
        ...
        if (this.evalExpr(this.cond)) {
          ...
          if (!parent.isLeaving) {
            ...
            _el.classList.remove(hooks.enter);
            _el.classList.remove(hooks.enterActive);
            _el.classList.add(hooks.leave);
            requestAnimationFrame(transitionHandler);
          }
        }
      };
...
if (__san_script__ &&
    __san_script__.__esModule &&
    Object.keys(__san_script__).length > 1) {
  console.warn("[san-loader] docs/src/components/Doc.san: named exports in *.san files are ignored.")}
